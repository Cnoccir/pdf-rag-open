...
class EnhancedResearchManager:
    ...
    def __init__(self, chat_args: ChatArgs):
        ...
        logger.info("Initialized EnhancedResearchManager")
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any], chat_args: ChatArgs) -> 'EnhancedResearchManager':
        """
        ...
        Returns:
            EnhancedResearchManager instance
        """
